...
const panelAgentNames = {
  main: "Cibele Amaral (Moderator)",
  "tanya-berger-wolf": "Tanya Berger-Wolf",
  "lauren-gillespie": "Lauren Gillespie",
  "jenna-kline": "Jenna Kline",
  "justin-kitzes": "Justin Kitzes",
  "katherine-siegel": "Katherine Siegel",
  "ty-tuff": "Ty Tuff",
  "jennifer-balch": "Jennifer Balch (Organizer)",
