...
| --- | --- | --- |
| OpenClaw Gateway | Human-facing PI Liaison and panel runtime | Respect role prompts, approval gates, and model routing |
...
| Slack | Optional PI Liaison intake and review surface | No arbitrary shell execution; approval gates still apply |
