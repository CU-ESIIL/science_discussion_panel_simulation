...
| --- | --- | --- |
| OpenClaw Gateway | Human-facing Interaction Agent and panel runtime | Respect role prompts, approval gates, and model routing |
...
| Slack | Optional Interaction Agent intake and review surface | No arbitrary shell execution; approval gates still apply |
